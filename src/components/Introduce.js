      ...
      <div className="container">
        <div id="content">
          <div>
            ...
            {/* Team section */}
            <h2 className="text-center wow fadeInDown animated" style={{ visibility: 'visible' }}>Đội ngũ của chúng tôi</h2>
            <div className="space20">&nbsp;</div>
            ...
            <div className="row">
              ...
              <div className="col-sm-6 wow fadeInLeft animated" style={{ visibility: 'visible' }}>
                <div className="beta-person media">
                  <img width="300" height="300" className="pull-left" src="..." alt="" />
            ...
            <div className="row">
              {/* Các thành viên */}
              {/* Copy từng thẻ col-sm-3 vào đây như trong class component */}
            </div>
          </div>
        </div>
      </div>
