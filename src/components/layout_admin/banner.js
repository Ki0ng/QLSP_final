  ...
  return (
    <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
      ...
      <ul className="navbar-nav ml-auto">
        {/* Nav Item - Search Dropdown (XS only) */}
        ...
        <li className="nav-item dropdown no-arrow mx-1">
          <div className="btn-group mt-2 float-left">
            <NavLink className="navbar-brand" onClick={handleLogout} to="/login">
        ...
        <li className="nav-item dropdown no-arrow">
          <a className="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <img className="img-profile rounded-circle" src="https://scontent.fsgn2-3.fna.fbcdn.net/..." />
          </a>
        </li>
      </ul>
    </nav>
